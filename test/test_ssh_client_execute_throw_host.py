...
def test_01_execute_through_host_no_creds(ssh, ssh_transport, exec_result):
    target = "127.0.0.2"
...
def test_02_execute_through_host_with_creds(ssh, ssh_transport, exec_result):
    target = "127.0.0.2"
    username_2 = "user2"
    password_2 = "pass2"
...
def test_03_execute_get_pty(ssh, ssh_transport_channel):
    target = "127.0.0.2"
